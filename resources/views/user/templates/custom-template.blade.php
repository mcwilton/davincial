				...
				<div class="card-body p-5 pb-0">
					...
					<div class="row">
						...
						@foreach ($template->fields as $value)
							<div class="col-sm-12">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold">{{ __($value['name']) }} @if ($value['status'] == 'required') <span class="text-required"><i class="fa-solid fa-asterisk"></i></span> @endif</h6>									
									<div class="form-group">						  
...
<script type="text/javascript">
	...
	$(function () {
		...
		const tinymceOptions = {
			...
			toolbar: 'AIMain AIOptions | styles | bold italic underline | alignleft aligncenter alignright | bullist numlist | forecolor backcolor emoticons | image link code | undo redo',
