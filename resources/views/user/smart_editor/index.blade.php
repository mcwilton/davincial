...
<div class="container-fluid pl-0 pr-0">
	<div class="col-md-12 smart-article-wrapper pl-0 pr-0">
		<div class="row no-gutters justify-content-center">
			<div class="col-sm-12 col-md-12 col-lg-2">
				<div id="main-templates-container" class="app-sidebar">
...
<script type="text/javascript">
	...
	$(function () {
		...
		const tinymceOptions = {
			...
			toolbar: 'AIMain | AIOptions | styles | bold italic link | alignleft aligncenter alignright | bullist numlist | forecolor backcolor emoticons | image link code | undo redo',
