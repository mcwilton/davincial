...
<aside class="app-sidebar"> 
    ...
    <ul class="side-menu app-sidebar3">
        ...
        @role('user|subscriber')
            @if (config('settings.smart_editor_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('Smart Editor') }}</span><span class="text-primary fs-9 side-menu__new">New</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
        ...
        @role('user|subscriber')
            @if (config('settings.rewriter_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('AI ReWriter') }}</span><span class="text-primary fs-9 side-menu__new">New</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
        ...
        @role('user|subscriber')
            @if (config('settings.chat_web_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('AI Web Chat') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
        ...
        @endrole
        @role('user|subscriber')
            @if (config('settings.chat_pdf_feature_user') == 'allow')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('user.chat.pdf') }}">
                    <span class="side-menu__icon lead-3 fs-18 fa-solid fa-file-pdf"></span>
                    <span class="side-menu__label">{{ __('AI Chat PDF') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
        ...
        @endrole
        @role('user|subscriber')
            @if (config('settings.chat_csv_feature_user') == 'allow')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('user.chat.csv') }}">
                    <span class="side-menu__icon lead-3 fs-18 fa-solid fa-file-csv"></span>
                    <span class="side-menu__label">{{ __('AI Chat CSV') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
        ...
        @role('user|subscriber')
            @if (config('settings.chat_image_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('AI Chat Image') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
        ...
        @role('user|subscriber')
            @if (config('settings.vision_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('AI Vision') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
