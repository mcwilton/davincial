...
use App\Http\Controllers\User\EmbeddingPDFController;
use App\Http\Controllers\User\EmbeddingCSVController;
...
use App\Http\Controllers\User\ChatPDFController;
use App\Http\Controllers\User\ChatCSVController;
...
Route::group(['prefix' => 'user', 'middleware' => ['verified', '2fa.verify', 'role:user|admin|subscriber', 'PreventBackHistory']], function() {
    ...
    Route::controller(ChatPDFController::class)->group(function () {        
        Route::get('/chat/pdf', 'index')->name('user.chat.pdf');      
        Route::post('/chat/pdf/process', 'process');   
        Route::post('/chat/pdf/clear', 'clear');     
        Route::post('/chat/pdf/conversation', 'conversation');                
        Route::post('/chat/pdf/rename', 'rename');
        Route::post('/chat/pdf/delete', 'delete');
        Route::post('/chat/pdf/metainfo', 'metainfo');
        Route::get('/chats/pdf/{code}', 'view');
        Route::post('/chat/pdf/credits', 'credits');
        Route::post('/chat/pdf/check-balance', 'checkBalance');
    });

    Route::controller(EmbeddingPDFController::class)->group(function () {        
        Route::post('/chat/pdf/embedding', 'store');      
    });

    // USER AI CHAT CSV ROUTES
    Route::controller(ChatCSVController::class)->group(function () {        
        Route::get('/chat/csv', 'index')->name('user.chat.csv');      
        Route::post('/chat/csv/process', 'process');   
        Route::post('/chat/csv/clear', 'clear');     
        Route::post('/chat/csv/conversation', 'conversation');                
        Route::post('/chat/csv/rename', 'rename');
        Route::post('/chat/csv/delete', 'delete');
        Route::post('/chat/csv/metainfo', 'metainfo');
        Route::post('/chat/csv/credits', 'credits');
        Route::get('/chats/csv/{code}', 'view');    
        Route::post('/chat/csv/check-balance', 'checkBalance');
    });

    Route::controller(EmbeddingCSVController::class)->group(function () {        
        Route::post('/chat/csv/embedding', 'store');      
    });
