        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('custom-model', function($row){
                        ...
                        $custom_storage = '<span class="font-weight-bold">'.$model.'</span>';
                        return $custom_storage;
                    })
                    ->addColumn('custom-credits', function($row){
                        $custom_storage = '<span>'.number_format($row["words"]) .' / '.number_format($row["images"]) . ' / '. number_format($row["characters"]) . ' / ' . number_format($row["minutes"]) .'</span>';
                        return $custom_storage;
                    })
