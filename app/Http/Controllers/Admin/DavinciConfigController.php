...
class DavinciConfigController extends Controller
{
    ...
    public function store()
    {
        ...
        $this->storeConfiguration('DAVINCI_SETTINGS_SMART_EDITOR_FREE_TIER_USER', request('smart-editor-user-access'));
        $this->storeConfiguration('DAVINCI_SETTINGS_REWRITER_FREE_TIER_USER', request('rewriter-user-access'));
        $this->storeConfiguration('DAVINCI_SETTINGS_REWRITER_FEATURE_USER', request('rewriter-feature-user'));
        $this->storeConfiguration('DAVINCI_SETTINGS_SMART_EDITOR_FEATURE_USER', request('smart-editor-feature-user'));
